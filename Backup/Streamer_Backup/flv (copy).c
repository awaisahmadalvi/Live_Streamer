...
int main (int argc, char *argv[]) {
	...
	*/
	...
	/*
		gst-launch-1.0 v4l2src device=/dev/video1 ! video/x-h264,width=640,height=480,framerate=15/1 ! flvmux ! progressreport ! 
	...
	*/
	...
	if ( !pipeline || !source || !flvmux || !queueLocal || !queueLive || !tee || !sinkLocal || !sinkLive  || !cap || !progReport || !bin || !valve || !filter ) {
