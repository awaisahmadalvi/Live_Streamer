...
void loop() {
    ...
    fZg = 0;
/*	printf("\nValue of AcX: %"  PRId16 "\n", AcX);
	printf("Value of AcY: %"  PRId16 "\n", AcY);
	printf("Value of Filter_ValueZ: %f", filter_valueZ);
*/	
	
    fXg = AcX * alpha + (fXg * (1.0 - alpha));
    fYg = AcY * alpha + (fYg * (1.0 - alpha));
    
/*  printf("\nValue after low pass filter of fXg: %.2f", fXg);
	printf("\nValue after low pass filter of fYg: %.2f", fYg);
	printf("\nValue after low pass filter of filter_value_Z: %.2f", filter_valueZ);
*/
...
/*  printf("\nValue in the form of g of AcX_G: %.4f", AcX_G);
	printf("\nValue in the form of g of AcY_G: %.4f", AcY_G);
	printf("\nValue in the form of g of AcZ_G: %.4f", AcZ_G);
*/    
    Abs_AcX_G = fabs(AcX_G);
    Abs_AcY_G = fabs(AcY_G);
    Abs_AcZ_G = fabs(AcZ_G);
    
    printf("\nAbsolute Value in the form of g of AcX_G: %.4f", Abs_AcX_G);
	printf("\nAbsolute Value in the form of g of AcY_G: %.4f", Abs_AcY_G);
	printf("\nAbsolute Value in the form of g of AcZ_G: %.4f", Abs_AcZ_G);
	
	//printf("Value of Raw Data: %"  PRId16 "\n", AcX);
    printf("\nTemperature of the room is:   %.2f ", Tmp_C);
    sleep(1);
}
