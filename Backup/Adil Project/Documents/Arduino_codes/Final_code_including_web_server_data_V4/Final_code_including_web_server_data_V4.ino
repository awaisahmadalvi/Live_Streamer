...
void loop() {
  for (int j = 0; j < 5 ; j++)
  {
    ...
    if ((((Abs_AcX_G > 0.003) && (Abs_AcY_G > 0.003)) || ((Abs_AcY_G > 0.003) && (Abs_AcZ_G > 0.003)) || ((Abs_AcZ_G > 0.003) && (Abs_AcX_G > 0.003))) && (count5 == 5))
    {
      count5 = 0;
      Earthquake_Alarm = 1;
      EarthQuakeCalculate();
    ...
    if (count5 < 5)                // EarthQuake printing
    {
      count5++;
      if (count5 == 4)
      {
