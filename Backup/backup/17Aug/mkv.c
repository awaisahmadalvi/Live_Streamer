...
int main (int argc, char *argv[]) {
	...
	*/
	...
	mkvmux  	= gst_element_factory_make ("matroskamux",	"mkv-mux");
	...
	gst_bin_add_many (GST_BIN (pipeline), source, mkvmux, queueLocal, tee, queueLive, sinkLocal, bin, NULL); //sinkLive, progReport, 
